...
const strings = {
  ko: {
    ...
    duelBtn: '⚔️ 결투 신청',
    duelChallenge: '도전',
    duelActiveDuels: '내 결투',
    duelPickOpponent: '상대 선택',
    duelSearchSummit: '정상 검색...',
    duelSend: '도전장 보내기',
    duelSentOk: '도전장을 보냈습니다! 상대가 수락하면 결투가 시작됩니다.',
    duelSendError: '도전장 전송에 실패했습니다',
    duelAccept: '수락',
    duelDecline: '거절',
    duelStatusPending: '수락 대기',
    duelStatusActive: '진행 중',
    duelWon: '🏆 승리',
    duelLost: '패배',
    duelEmpty: '진행 중인 결투가 없습니다',
    duelNoFollowing: '팔로잉한 등산객이 없습니다',
    duelNoSummits: '검색 결과가 없습니다',
    duelVsYou: '나',
    duelExpiry: '만료',
    ...
    // Group Hike Events
    groupHikeTitle: '👥 단체 등산 이벤트',
    groupHikeTabSummit: '이 정상',
    groupHikeTabAll: '전체 일정',
    groupHikeEmpty: '예정된 단체 등산이 없습니다',
    groupHikeCreate: '+ 단체 등산 만들기',
    groupHikeDateLabel: '날짜 선택',
    groupHikeDescLabel: '메모 (선택사항)',
    groupHikeDescPlaceholder: '이 등산에 대해 한마디… (최대 120자)',
    groupHikeSave: '이벤트 등록',
    groupHikeCreateError: '이벤트 생성에 실패했습니다',
    groupHikeBy: (name: string) => `주최: ${name}`,
    groupHikeAttendees: (n: number) => `${n}명 참가`,
    groupHikeJoin: '참가',
    groupHikeLeave: '취소',
    groupHikeDeleteTitle: '이벤트 삭제',
    groupHikeDeleteMsg: '이 이벤트를 삭제하시겠습니까?',
    ...
    // Hike Mood Tracker
    moodBtn: '😊 하이킹 기분 기록',
    moodTitle: '😊 하이킹 기분 트래커',
    moodTabLog: '기록하기',
    moodTabHistory: '기록 보기',
    moodSummitLabel: '봉우리 이름',
    moodSummitHint: '예) 북한산',
    moodSummitRequired: '봉우리 이름을 입력하세요.',
    moodBeforeLabel: '등산 전 기분',
    moodAfterLabel: '등산 후 기분',
    moodNoteLabel: '메모 (선택)',
    moodNoteHint: '오늘 등산은 어땠나요?',
    moodSave: '💾 기록 저장',
    moodStatTotal: '총 기록',
    moodStatLift: '평균 기분 향상',
    moodStatBest: '베스트 봉우리',
    moodEmpty: '기분 기록이 없습니다.\n첫 등산 기분을 기록해 보세요!',
    moodDeleteTitle: '기록 삭제',
    moodDeleteConfirm: '이 기분 기록을 삭제하시겠습니까?',

    // Hike Pace Calculator
    paceBtn: '🏃 등산 페이스 계산기',
    paceTitle: '🏃 등산 페이스 계산기',
    paceTabCalc: '계산',
    paceTabHistory: '저장 기록',
    paceDistLabel: '거리 (km)',
    paceDistHint: '예) 5.2',
    paceElevLabel: '고도 상승 (m)',
    paceElevHint: '예) 450',
    paceFitLabel: '체력 수준',
    paceFitBeginner: '입문자',
    paceFitIntermediate: '일반',
    paceFitExpert: '숙련자',
    paceCalcBtn: '⏱️ 예상 시간 계산',
    paceResultTitle: '예상 소요 시간',
    paceResultTime: (h: number, m: number) => h > 0 ? `${h}시간 ${m}분` : `${m}분`,
    paceDistMin: (m: number) => `평지 거리: ${m}분`,
    paceElevMin: (m: number) => `고도 상승: ${m}분`,
    paceSplit: (m: number) => `100m 상승당 약 ${m}분`,
    paceSaveBtn: '💾 저장',
    paceSaveLabel: '메모 (선택)',
    paceSaveHint: '예) 북한산 코스',
    paceSaved: '저장됐습니다!',
    paceEmpty: '저장된 기록이 없습니다.',
    paceDeleteTitle: '기록 삭제',
    paceDeleteConfirm: '이 페이스 기록을 삭제하시겠습니까?',
    paceDistSummary: (km: number) => `${km}km`,
    paceElevSummary: (m: number) => `+${m}m`,
  },
  ...
  en: {
    ...
    // Summit Duel
    duelTitle: '⚔️ Summit Duel',
    duelBtn: '⚔️ Challenge to Duel',
    duelChallenge: 'Challenge',
    duelActiveDuels: 'My Duels',
    duelPickOpponent: 'Pick opponent',
    duelSearchSummit: 'Search summit...',
    duelSend: 'Send Challenge',
    duelSentOk: 'Challenge sent! The duel starts when they accept.',
    duelSendError: 'Failed to send challenge',
    duelAccept: 'Accept',
    duelDecline: 'Decline',
    duelStatusPending: 'Awaiting',
    duelStatusActive: 'Active',
    duelWon: '🏆 Won',
    duelLost: 'Lost',
    duelEmpty: 'No active duels',
    duelNoFollowing: 'Follow other hikers to challenge them',
    duelNoSummits: 'No summits found',
    duelVsYou: 'You',
    duelExpiry: 'Expires',
    ...
    // Group Hike Events
    groupHikeTitle: '👥 Group Hike Events',
    groupHikeTabSummit: 'This Summit',
    groupHikeTabAll: 'All Events',
    groupHikeEmpty: 'No upcoming group hikes',
    groupHikeCreate: '+ Create Group Hike',
    groupHikeDateLabel: 'Select Date',
    groupHikeDescLabel: 'Note (optional)',
    groupHikeDescPlaceholder: 'Tell us about this hike… (max 120 chars)',
    groupHikeSave: 'Create Event',
    groupHikeCreateError: 'Failed to create event',
    groupHikeBy: (name: string) => `By: ${name}`,
    groupHikeAttendees: (n: number) => `${n} going`,
    groupHikeJoin: 'Join',
    groupHikeLeave: 'Leave',
    groupHikeDeleteTitle: 'Delete Event',
    groupHikeDeleteMsg: 'Delete this group hike event?',
    ...
    // Hike Mood Tracker
    moodBtn: '😊 Hike Mood Tracker',
    moodTitle: '😊 Hike Mood Tracker',
    moodTabLog: 'Log Mood',
    moodTabHistory: 'History',
    moodSummitLabel: 'Summit Name',
    moodSummitHint: 'e.g. Bukhansan',
    moodSummitRequired: 'Please enter a summit name.',
    moodBeforeLabel: 'Mood Before Hike',
    moodAfterLabel: 'Mood After Hike',
    moodNoteLabel: 'Note (optional)',
    moodNoteHint: 'How was today\'s hike?',
    moodSave: '💾 Save Entry',
    moodStatTotal: 'Total Logs',
    moodStatLift: 'Avg Mood Lift',
    moodStatBest: 'Best Summit',
    moodEmpty: 'No mood entries yet.\nLog your first hike mood!',
    moodDeleteTitle: 'Delete Entry',
    moodDeleteConfirm: 'Delete this mood entry?',

    // Hike Pace Calculator
    paceBtn: '🏃 Hike Pace Calculator',
    paceTitle: '🏃 Hike Pace Calculator',
    paceTabCalc: 'Calculate',
    paceTabHistory: 'Saved',
    paceDistLabel: 'Distance (km)',
    paceDistHint: 'e.g. 5.2',
    paceElevLabel: 'Elevation Gain (m)',
    paceElevHint: 'e.g. 450',
    paceFitLabel: 'Fitness Level',
    paceFitBeginner: 'Beginner',
    paceFitIntermediate: 'Intermediate',
    paceFitExpert: 'Expert',
    paceCalcBtn: '⏱️ Calculate Time',
    paceResultTitle: 'Estimated Duration',
    paceResultTime: (h: number, m: number) => h > 0 ? `${h}h ${m}m` : `${m}m`,
    paceDistMin: (m: number) => `Flat distance: ${m} min`,
    paceElevMin: (m: number) => `Elevation gain: ${m} min`,
    paceSplit: (m: number) => `~${m} min per 100 m gain`,
    paceSaveBtn: '💾 Save',
    paceSaveLabel: 'Label (optional)',
    paceSaveHint: 'e.g. Bukhansan route',
    paceSaved: 'Saved!',
    paceEmpty: 'No saved calculations yet.',
    paceDeleteTitle: 'Delete Entry',
    paceDeleteConfirm: 'Delete this pace record?',
    paceDistSummary: (km: number) => `${km}km`,
    paceElevSummary: (m: number) => `+${m}m`,
  },
  ...
  ja: {
    ...
    duelBtn: '⚔️ 決闘を挑む',
    duelChallenge: '挑戦',
    duelActiveDuels: '私の決闘',
    duelPickOpponent: '相手を選ぶ',
    duelSearchSummit: '山頂を検索...',
    duelSend: '決闘状を送る',
    duelSentOk: '決闘状を送りました！相手が承諾すると決闘が始まります。',
    duelSendError: '決闘状の送信に失敗しました',
    duelAccept: '受け入れる',
    duelDecline: '断る',
    duelStatusPending: '承諾待ち',
    duelStatusActive: '進行中',
    duelWon: '🏆 勝利',
    duelLost: '敗北',
    duelEmpty: '進行中の決闘はありません',
    duelNoFollowing: '他の登山者をフォローして挑戦しましょう',
    ...
    // Group Hike Events
    groupHikeTitle: '👥 グループ登山イベント',
    groupHikeTabSummit: 'この山頂',
    groupHikeTabAll: '全イベント',
    groupHikeEmpty: '予定されているグループ登山はありません',
    groupHikeCreate: '+ グループ登山を作成',
    groupHikeDateLabel: '日付を選択',
    groupHikeDescLabel: 'メモ（任意）',
    groupHikeDescPlaceholder: 'この登山について… （最大120文字）',
    groupHikeSave: 'イベント作成',
    groupHikeCreateError: 'イベントの作成に失敗しました',
    groupHikeBy: (name: string) => `主催: ${name}`,
    groupHikeAttendees: (n: number) => `${n}人参加`,
    groupHikeJoin: '参加',
    groupHikeLeave: 'キャンセル',
    groupHikeDeleteTitle: 'イベント削除',
    groupHikeDeleteMsg: 'このグループ登山イベントを削除しますか？',
    ...
    // Hike Mood Tracker
    moodBtn: '😊 ハイク気分トラッカー',
    moodTitle: '😊 ハイク気分トラッカー',
    moodTabLog: '記録する',
    moodTabHistory: '履歴',
    moodSummitLabel: '山頂名',
    moodSummitHint: '例）北漢山',
    moodSummitRequired: '山頂名を入力してください。',
    moodBeforeLabel: 'ハイク前の気分',
    moodAfterLabel: 'ハイク後の気分',
    moodNoteLabel: 'メモ（任意）',
    moodNoteHint: '今日のハイクはどうでしたか？',
    moodSave: '💾 記録を保存',
    moodStatTotal: '総記録数',
    moodStatLift: '平均気分向上',
    moodStatBest: 'ベスト山頂',
    moodEmpty: '気分の記録がありません。\n最初のハイク気分を記録しましょう！',
    moodDeleteTitle: '記録を削除',
    moodDeleteConfirm: 'この気分記録を削除しますか？',
    ...
    paceFitLabel: '体力レベル',
    paceFitBeginner: '初心者',
    paceFitIntermediate: '中級者',
    paceFitExpert: '上級者',
    paceCalcBtn: '⏱️ 所要時間を計算',
    paceResultTitle: '予想所要時間',
    paceResultTime: (h: number, m: number) => h > 0 ? `${h}時間${m}分` : `${m}分`,
    paceDistMin: (m: number) => `平地距離: ${m}分`,
    paceElevMin: (m: number) => `標高差: ${m}分`,
    paceSplit: (m: number) => `100m標高差あたり約${m}分`,
    paceSaveBtn: '💾 保存',
    paceSaveLabel: 'メモ（任意）',
    paceSaveHint: '例）北漢山コース',
    paceSaved: '保存しました！',
    paceEmpty: '保存された記録がありません。',
    paceDeleteTitle: '記録を削除',
    paceDeleteConfirm: 'このペース記録を削除しますか？',
    paceDistSummary: (km: number) => `${km}km`,
    paceElevSummary: (m: number) => `+${m}m`,
  },
} as const;
